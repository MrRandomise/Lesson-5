...
namespace SaveSystem.Core
{
    ...
    {
        private readonly ISaveLoade saveLoader;
        private readonly List<Dictionary<string, string>> otherSceneEntries = new() ;


        public SaveSystem(ISaveLoade sl)
        {
            saveLoader = sl;
        }

        public bool RestoreState(List<ISaveState> saveAbles)
        {
        ...
        public void CaptureState(List<ISaveState> saveAbles)
        {
